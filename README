...
🎓 Master's in Embedded Systems Software @ [Université de Bretagne Occidentale](https://www.univ-brest.fr/) (Brest, France)  
...
![Ada](https://img.shields.io/badge/-Ada-0033A0?style=flat-square)

**Embedded Systems**  
![Linux](https://img.shields.io/badge/-Linux_Kernel-FCC624?style=flat-square&logo=linux&logoColor=black)
![FreeRTOS](https://img.shields.io/badge/-FreeRTOS-8BC34A?style=flat-square)
...
<p align="center">
  <i>Open to opportunities in Embedded AI, Edge Computing, and Safety-Critical Systems across Europe.</i>
</p>
